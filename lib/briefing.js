...
async function gatherMarketData(type) {
  ...
  const queries = {
    morning: [
      ...
      "VN-Index RSI MACD phân tích kỹ thuật hôm nay",
    ...
    midday: [
      ...
      "VN-Index RSI phân tích kỹ thuật giữa phiên",
    ...
    eod: [
      ...
      "VN-Index RSI MACD Bollinger Bands phân tích kỹ thuật",
...
function buildPrompt(type, marketData, watchlist) {
  ...
  const rsiGuide = `
Hướng dẫn phân tích RSI:
- RSI > 70: vùng overbought (quá mua) — cảnh báo điều chỉnh
- RSI 50-70: xu hướng tăng
- RSI 30-50: xu hướng giảm
- RSI < 30: vùng oversold (quá bán) — cơ hội mua
Kết hợp RSI với MACD và Bollinger Bands để xác nhận tín hiệu.`;
...
1. VN-Index & HNX-Index: điểm số, % thay đổi, khối lượng
2. Phân tích kỹ thuật VN-Index:
   - RSI hiện tại & tín hiệu (overbought/oversold/trung tính)
   - MACD: xu hướng, cắt lên/xuống đường signal
   - Bollinger Bands: giá đang ở vùng nào
   - Vùng hỗ trợ/kháng cự quan trọng
3. Top 5 cổ phiếu tăng mạnh & top 5 giảm mạnh nhất HOSE
4. Phân tích nhanh danh mục (${tickers}): giá, RSI, tín hiệu kỹ thuật ngắn
5. Dòng tiền khối ngoại: net buy/sell, top mã mua/bán ròng
6. Thị trường Mỹ qua đêm: S&P 500, Nasdaq, DXY, dầu WTI, tín hiệu Fed
7. Sự kiện chính trị/kinh tế thế giới tác động hôm nay
8. Khuyến nghị mở cửa: 2-3 câu ngắn gọn dựa trên tín hiệu kỹ thuật

Viết bằng tiếng Việt, tông chuyên nghiệp, súc tích, format rõ ràng.`,
...
2. Phân tích kỹ thuật giữa phiên:
   - RSI khung 15 phút & 1 giờ — tín hiệu ngắn hạn
   - Momentum: đang tăng tốc hay giảm tốc
   - Vùng hỗ trợ/kháng cự cần theo dõi phiên chiều
3. Tin tức trong ngày: chính trị, kinh tế thế giới, sự kiện nổi bật
4. IPOs hôm nay & cổ phiếu đáng chú ý phiên chiều
5. Cập nhật nhanh danh mục (${tickers}): RSI hiện tại, so sánh với mở cửa
6. 2-3 cổ phiếu nên xem xét phiên chiều — có RSI và lý do cụ thể
...
2. Phân tích kỹ thuật tổng kết:
   - RSI đóng cửa: vùng nào, xu hướng so với hôm qua
   - MACD: tín hiệu mua/bán, phân kỳ nếu có
   - Bollinger Bands: breakout hay consolidation
   - Nhận định xu hướng ngắn hạn (1-3 phiên tới)
3. Top 5 cổ phiếu tăng mạnh nhất & top 5 giảm mạnh nhất cả ngày
4. Dòng tiền khối ngoại cả ngày: tổng net buy/sell, top mã
5. Kết quả danh mục (${tickers}): RSI đóng cửa, tín hiệu cho ngày mai
6. Định hướng & điểm then chốt cần theo dõi cho ngày mai dựa trên RSI/MACD
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:8px;overflow:hidden;">
  ...
  <tr>
    <td style="padding:16px 32px;text-align:center;border-top:1px solid #eee;">
      ...
      <p style="font-size:11px;color:#aaa;margin:10px 0 0;">VCB · TCB · VNM · HPG · VN-Index · RSI · MACD · Bollinger Bands · MA</p>
    </td>
  </tr>
  <tr>
    <td style="background:#f7f7f7;padding:10px 32px;text-align:center;">
