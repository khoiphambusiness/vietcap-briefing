...
async function gatherMarketData(type) {
  ...
  const [
    ...
    search("VN-Index HNX-Index cổ phiếu tăng giảm mạnh khối ngoại " + today, "vi", "vn"),
    search("NHNN lãi suất tỷ giá GDP lạm phát chính sách đầu tư công Việt Nam " + today, "vi", "vn"),
    search("kết quả kinh doanh doanh nghiệp niêm yết IPO chính trị Việt Nam " + today, "vi", "vn"),
    searchNews("Federal Reserve interest rate S&P 500 Nasdaq Dow Jones market today 2026", "en", "us"),
    searchNews("US CPI GDP jobs economic data tech AI semiconductor earnings 2026", "en", "us"),
    searchNews("Iran Israel Middle East war Ukraine Russia Europe energy market 2026", "en", "us"),
    searchNews("US China trade tariff Asia Pacific Taiwan geopolitics market impact 2026", "en", "us"),
    searchNews("crude oil WTI Brent OPEC production supply demand price today 2026", "en", "us"),
    searchNews("gold silver steel copper iron ore commodity price today 2026", "en", "us"),
    searchNews("DXY dollar index Asian currencies emerging market FX USD 2026", "en", "us"),
    searchNews("China economy GDP stimulus emerging markets Vietnam capital flows 2026", "en", "us"),
    searchNews("Europe ECB economy global trade supply chain inflation 2026", "en", "us"),
    searchNews("technology AI chip semiconductor stock market 2026", "en", "us"),
    searchNews("global banking financial sector real estate Asia credit risk 2026", "en", "us"),
    searchNews("agriculture rice wheat energy renewable sector 2026", "en", "us"),
  ]);

  return {
    vietnam: { vnMarket, vnMacroPolicy, vnCorporate },
    usMarket: { usFedMarket, usEconTech },
    geopolitics: { geoMiddleEastUkraine, geoUSTradAsia },
    commodities: { oilGasOpec, goldMetals, agriculture },
    currencies: { dxyFX },
    globalEcon: { chinaEM, euroGlobal },
    sectors: { sectorsTech, sectorsFinance },
  };
}
...
function formatData(data) {
  return `
=== THỊ TRƯỜNG VIỆT NAM ===
VN-Index/HNX/Top movers/Khối ngoại: ${data.vietnam.vnMarket}
Vĩ mô/Chính sách VN: ${data.vietnam.vnMacroPolicy}
Corporate/IPO/Chính trị VN: ${data.vietnam.vnCorporate}

=== THỊ TRƯỜNG MỸ & FED ===
Fed/Lãi suất/S&P500/Nasdaq: ${data.usMarket.usFedMarket}
Kinh tế Mỹ/Tech/AI: ${data.usMarket.usEconTech}

=== ĐỊA CHÍNH TRỊ & XUNG ĐỘT ===
Iran/Israel/Ukraine/Nga/Trung Đông/Châu Âu: ${data.geopolitics.geoMiddleEastUkraine}
Mỹ-Trung/Thuế quan/Châu Á-TBD/Đài Loan: ${data.geopolitics.geoUSTradAsia}

=== HÀNG HÓA ===
Dầu WTI/Brent/OPEC: ${data.commodities.oilGasOpec}
Vàng/Bạc/Thép/Đồng: ${data.commodities.goldMetals}
Nông sản/Năng lượng: ${data.commodities.agriculture}

=== TIỀN TỆ & DÒNG VỐN ===
DXY/USD/Tiền tệ châu Á/EM: ${data.currencies.dxyFX}

=== KINH TẾ TOÀN CẦU ===
Trung Quốc/EM/Vốn ngoại: ${data.globalEcon.chinaEM}
Châu Âu/ECB/Thương mại toàn cầu: ${data.globalEcon.euroGlobal}

=== NGÀNH ===
Tech/AI/Chip/Semiconductor: ${data.sectors.sectorsTech}
Ngân hàng/Tài chính/BĐS châu Á: ${data.sectors.sectorsFinance}
`;
}
